...
if SAE:
    ROOT_URLCONF = 'urls'
    path_func = lambda app_name:   app_name.startswith('djblog')  and app_name.replace('djblog.', '') or app_name
    INSTALLED_APPS =   map( path_func,  INSTALLED_APPS )
    TEMPLATE_CONTEXT_PROCESSORS = map( path_func,  TEMPLATE_CONTEXT_PROCESSORS)
